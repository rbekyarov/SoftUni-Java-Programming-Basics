...
12.	Песента на колелетата
        ...
        •	Ако са намерени четворки числа (аbcd), отговарящи на условието, ги отпечатваме всичките с
        разделител интервал: “{а}{b}{c}{d} ”
...
public class p12Песента_на_колелетата {
    public static void main(String[] args) {
        Scanner input = new Scanner(System.in);
        int controlValue = Integer.parseInt(input.nextLine());
        int value = 0;
        int count = 0;
        int password = 0;
        boolean found = false;
