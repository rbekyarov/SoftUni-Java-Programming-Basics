...
public class p7if_else_Световен_рекорд_по_плуване {
    ...
    Scanner scanner = new Scanner(System.in);
        ...
        double vreme = sekundi*razstoyanieM;
        double puti = razstoyanieM/15;
        double vremezakusnenie = Math.floor(puti)*12.5;
        double totalvreme = sekundi*razstoyanieM+vremezakusnenie;
        double razlika = totalvreme-rekord;
        if (totalvreme<rekord){
            System.out.printf("Yes, he succeeded! The new world record is %.2f seconds.",totalvreme);
        } else{
