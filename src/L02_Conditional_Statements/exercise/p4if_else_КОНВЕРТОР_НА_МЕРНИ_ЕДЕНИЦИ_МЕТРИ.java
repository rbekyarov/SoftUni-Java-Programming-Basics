...
public class p4if_else_КОНВЕРТОР_НА_МЕРНИ_ЕДЕНИЦИ_МЕТРИ {
    public static void main(String[] args) {
        ...
        boolean x1 = !((x.equals("mm")) || x.equals("cm") || x.equals("mi") || x.equals("in") || x.equals("km") || x.equals("ft") || x.equals("yd") || x.equals("m"));
        if (x1) {
        ...
        boolean y1 = !(y.equals("mm") || y.equals("cm") || y.equals("mi") || y.equals("in") || y.equals("km") || y.equals("ft") || y.equals("yd") || y.equals("m"));
        if (y1) {
            System.out.println("Грешка при въвеждане");
            System.out.println("Моля въведете отново из между - mm,cm,m,km,mi,in,ft,yd ");
            y = scanner.nextLine();
        ...
        System.out.printf("Резултат: %.0f(%s) = %.2f(%s)", num, x, result, y);
