...
public class p6if_else_Godzilla_vs_Kingkong {
    ...
    public static void main(String[] args) {
        ...
        double price = people * priceClothing;
        if (people > 150) {
            price = price - price * 0.1;
        }
        double money = decor + price;
        double balance = money - budjet;
        if (money > budjet) {
            System.out.println("Not enough money!");
            System.out.printf("Wingard needs %.2f leva more.", balance);
        } else {
            System.out.println("Action!");
            System.out.printf("Wingard starts filming with %.2f leva left.", Math.abs(balance));
        }
